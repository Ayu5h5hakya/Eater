...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxCoreLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.core.splashscreen</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxTvLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.tv.foundation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
         ...
         * with version reference <b>androidx.tv.material</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxWearComposeLibraryAccessors extends SubDependencyFactory {
        private final AndroidxWearComposeUiLibraryAccessors laccForAndroidxWearComposeUiLibraryAccessors = new AndroidxWearComposeUiLibraryAccessors(owner);
         ...
         */
        public Provider<MinimalExternalModuleDependency> getMaterial() {
            return create("androidx.wear.compose.material");
        }
        ...
        /**
         * Group of libraries at <b>androidx.wear.compose.ui</b>
         */
        public AndroidxWearComposeUiLibraryAccessors getUi() {
            return laccForAndroidxWearComposeUiLibraryAccessors;
        }

    }

    public static class AndroidxWearComposeUiLibraryAccessors extends SubDependencyFactory {

        public AndroidxWearComposeUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getTooling() {
            return create("androidx.wear.compose.ui.tooling");
        }
    ...
    public static class HorologistLibraryAccessors extends SubDependencyFactory {
        private final HorologistAudioLibraryAccessors laccForHorologistAudioLibraryAccessors = new HorologistAudioLibraryAccessors(owner);
        ...
        private final HorologistImagesLibraryAccessors laccForHorologistImagesLibraryAccessors = new HorologistImagesLibraryAccessors(owner);
        private final HorologistMediaLibraryAccessors laccForHorologistMediaLibraryAccessors = new HorologistMediaLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>horologist.audio</b>
         */
        public HorologistAudioLibraryAccessors getAudio() {
            return laccForHorologistAudioLibraryAccessors;
        }
        ...
        /**
         * Group of libraries at <b>horologist.images</b>
         */
        public HorologistImagesLibraryAccessors getImages() {
            return laccForHorologistImagesLibraryAccessors;
        }

        /**
         * Group of libraries at <b>horologist.media</b>
         */
        public HorologistMediaLibraryAccessors getMedia() {
            return laccForHorologistMediaLibraryAccessors;
        }

    }

    public static class HorologistAudioLibraryAccessors extends SubDependencyFactory {

        public HorologistAudioLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ui</b> with <b>com.google.android.horologist:horologist-audio-ui</b> coordinates and
         * with version reference <b>horologist</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getUi() {
            return create("horologist.audio.ui");
        }
    ...
    public static class HorologistImagesLibraryAccessors extends SubDependencyFactory {

        public HorologistImagesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>coil</b> with <b>com.google.android.horologist:horologist-images-coil</b> coordinates and
         * with version reference <b>horologist</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCoil() {
            return create("horologist.images.coil");
        }

    }

    public static class HorologistMediaLibraryAccessors extends SubDependencyFactory {

        public HorologistMediaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>data</b> with <b>com.google.android.horologist:horologist-media-data</b> coordinates and
         * with version reference <b>horologist</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getData() {
            return create("horologist.media.data");
        }

        /**
         * Dependency provider for <b>ui</b> with <b>com.google.android.horologist:horologist-media-ui</b> coordinates and
         * with version reference <b>horologist</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getUi() {
            return create("horologist.media.ui");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>horologist</b> with value <b>0.6.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>roborazzi</b> with value <b>1.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxTvVersionAccessors vaccForAndroidxTvVersionAccessors = new AndroidxTvVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>androidx.glance</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidx.window</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.androidx.tv</b>
         */
        public AndroidxTvVersionAccessors getTv() {
            return vaccForAndroidxTvVersionAccessors;
        }
    ...
    public static class AndroidxActivityVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.activity.compose</b> with value <b>1.9.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxBenchmarkVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>androidx.benchmark</b> with value <b>1.2.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidx.benchmark.junit4</b> with value <b>1.2.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.compose.bom</b> with value <b>2024.09.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxCoreVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.core.splashscreen</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxLifecycleVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>androidx.lifecycle.compose</b> with value <b>2.8.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxLifecycleRuntimeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.lifecycle.runtime.compose</b> with value <b>2.8.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxTvVersionAccessors extends VersionFactory  {

        public AndroidxTvVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>androidx.tv.foundation</b> with value <b>1.0.0-alpha11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFoundation() { return getVersion("androidx.tv.foundation"); }

        /**
         * Version alias <b>androidx.tv.material</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterial() { return getVersion("androidx.tv.material"); }
    ...
    public static class AndroixTestVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androix.test.uiautomator</b> with value <b>2.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PlayServicesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>play.services.wearable</b> with value <b>18.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
